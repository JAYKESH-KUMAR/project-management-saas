...
// Create project
 export const createProject = async (req, res) => {
    ...
    res.json({project:projectWithMember,message:"Project created successfully"});
    ...
    try {
        ...
        if(!workspace.members.some((member)=>member.userId === userId && member.role === "ADMIN")){
            ...
            if(!project){
                ...
                return res.status(403).json({message:"You don't have permission to update this project in this workspace"});
            }
        }
